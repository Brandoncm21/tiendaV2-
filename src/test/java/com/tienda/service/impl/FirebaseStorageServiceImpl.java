...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    private String uploadFile(File file, String carpeta, String fileName) throws IOException {
        ...
        ClassPathResource json = new ClassPathResource(FirebaseStorageService.RUTA_JSON_FILE + File.separator + FirebaseStorageService.ARCHIVO_JSON_FILE);
        BlobId blobId = BlobId.of(FirebaseStorageService.BUCKET_NAME, FirebaseStorageService.RUTA_SUPERIOR_STORAGE + "/" + carpeta + "/" + fileName);
